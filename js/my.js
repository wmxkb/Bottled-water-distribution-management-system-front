...
document.addEventListener('plusready', function(e) {
	...
	logout.addEventListener('tap', function(e) {
	...
	if (userid != '10001')
		mui.ajax(url + api, {
			...
			error: function(xhr, type, errorThrown) {
				console.log("个人信息页面更新数据出错")
			}
		});

	// 购物车内商品数量
	mui.ajax(url + '/getShoppingTrolleyCount', {
		data: {
			'userid': userid
		},
		dataType: 'json', //服务器返回json格式数据
